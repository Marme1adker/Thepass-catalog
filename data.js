...
async function fetchGames() {
  return [
    ...
    // ── marme1adker — локальный аккаунт ────────────────────────────────────────
    // Все игры доступны мгновенно ⚡ (Steam Guard через get_code)
    ...
    { title: 'Ведьмак 3: Дикая Охота', short: 'Ведьмак 3: Дикая Охо', group: 'CD Projekt Red', img: steamImg(292030), tags: ['Открытый мир', 'RPG', 'Сюжет', 'Фэнтези'], opts: ['ru'], source: 'local', marme1adker: true },
    { title: 'ЗВЁЗДНЫЕ ВОЙНЫ Джедаи: Павший Орден', short: 'ЗВЁЗДНЫЕ ВОЙНЫ Джеда', group: 'PlayStation', img: steamImg(1172380), tags: ['Экшн', 'Сюжет', 'Звёздные войны'], opts: ['ru'], source: 'local', marme1adker: true },
    ...
    { title: 'Одни из нас™, Часть I', short: 'Одни из нас™, Часть ', group: 'PlayStation', img: steamImg(1888930), tags: ['Хоррор', 'Сюжет', 'Выживание'], opts: ['ru'], source: 'local', marme1adker: true },
    { title: 'Призрак Цусимы: Режиссёрская версия', short: 'Призрак Цусимы: Режи', group: 'PlayStation', img: steamImg(2215430), tags: ['Открытый мир', 'Самурай', 'Стелс'], opts: ['ru'], source: 'local', marme1adker: true },
    ...
    { title: 'Хогвартс. Наследие', short: 'Хогвартс. Наследие', group: 'PlayStation', img: steamImg(990080), tags: ['Открытый мир', 'RPG', 'Фэнтези', 'Сюжет'], opts: ['ru'], source: 'local', marme1adker: true },
    { title: 'Absolver', short: 'Absolver', group: 'Инди • Разное', img: steamImg(473690), tags: ['Файтинг', 'Экшн', 'Кооп'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Aimlabs', short: 'Aimlabs', group: 'Инди • Разное', img: steamImg(714010), tags: ['Казуальное', 'Утилита'], opts: [], source: 'local', marme1adker: true },
    { title: 'Aloft', short: 'Aloft', group: 'Инди • Разное', img: steamImg(1660080), tags: ['Выживание', 'Крафт', 'Кооп'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Amerzone: The Explorer\'s Legacy (1999)', short: 'Amerzone: The Explor', group: 'Инди • Разное', img: steamImg(2060100), tags: ['Приключение', 'Классика'], opts: [], source: 'local', marme1adker: true },
    { title: 'Ampersat', short: 'Ampersat', group: 'Инди • Разное', img: steamImg(1356040), tags: ['Инди', 'Необычное'], opts: [], source: 'local', marme1adker: true },
    { title: 'AniCursor', short: 'AniCursor', group: 'Инди • Разное', img: steamImg(1742020), tags: ['Утилита', 'Кастомизация'], opts: [], source: 'local', marme1adker: true },
    { title: 'Arabian Gulf', short: 'Arabian Gulf', group: 'Инди • Разное', img: steamImg(1501860), tags: ['Симулятор', 'Необычное'], opts: [], source: 'local', marme1adker: true },
    { title: 'ARK: Survival Of The Fittest', short: 'ARK: Survival Of The', group: 'Инди • Разное', img: steamImg(407530), tags: ['Выживание', 'Динозавры', 'Мультиплеер'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Assassin\'s Creed II', short: 'Assassin\'s Creed II', group: 'Ubisoft', img: steamImg(33230), tags: ['Инди'], opts: [], source: 'local', marme1adker: true },
    { title: 'Assassin\'s Creed Единство', short: 'Assassin\'s Creed Ед', group: 'Ubisoft', img: steamImg(289650), tags: ['Инди'], opts: [], source: 'local', marme1adker: true },
    { title: 'Assassin\'s Creed Синдикат', short: 'Assassin\'s Creed Си', group: 'Ubisoft', img: steamImg(368500), tags: ['Инди'], opts: [], source: 'local', marme1adker: true },
    { title: 'Assassin\'s Creed Истоки', short: 'Assassin\'s Creed Ис', group: 'Ubisoft', img: steamImg(582160), tags: ['Инди'], opts: [], source: 'local', marme1adker: true },
    { title: 'Assassin\'s Creed Mirage', short: 'Assassin\'s Creed Mi', group: 'Ubisoft', img: steamImg(3035570), tags: ['Инди'], opts: [], source: 'local', marme1adker: true },
    { title: 'Assassin\'s Creed Odyssey', short: 'Assassin\'s Creed Od', group: 'Ubisoft', img: steamImg(812140), tags: ['Инди'], opts: [], source: 'local', marme1adker: true },
    ...
    { title: 'Baldur\'s Gate 3', short: 'Baldur\'s Gate 3', group: 'Larian Studios', img: steamImg(1086940), tags: ['RPG', 'Кооп', 'Фэнтези', 'Сюжет'], opts: ['dlc', 'online'], source: 'local', marme1adker: true },
    { title: 'Banana Hell: Mountain of Madness', short: 'Banana Hell: Mountai', group: 'Инди • Разное', img: steamImg(2068520), tags: ['Инди', 'Необычное'], opts: [], source: 'local', marme1adker: true },
    { title: 'Battlestar Galactica Deadlock', short: 'Battlestar Galactica', group: 'Инди • Разное', img: steamImg(544610), tags: ['Стратегия', 'Фантастика', 'Космос'], opts: ['dlc'], source: 'local', marme1adker: true },
    { title: 'Billies Wheelie', short: 'Billies Wheelie', group: 'Инди • Разное', img: steamImg(3180310), tags: ['Инди', 'Физика'], opts: [], source: 'local', marme1adker: true },
    { title: 'Black Desert', short: 'Black Desert', group: 'Инди • Разное', img: steamImg(582010), tags: ['MMORPG', 'Открытый мир'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Blacktop Hoops', short: 'Blacktop Hoops', group: 'Инди • Разное', img: steamImg(1659440), tags: ['Спорт', 'Аркада'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Blade & Sorcery', short: 'Blade & Sorcery', group: 'Инди • Разное', img: steamImg(629730), tags: ['VR', 'Экшн', 'Фэнтези'], opts: [], source: 'local', marme1adker: true },
    { title: 'BLEACH Brave Souls - 3D Action', short: 'BLEACH Brave Souls -', group: 'Инди • Разное', img: steamImg(1490580), tags: ['Экшн', 'Аниме', 'Мультиплеер'], opts: [], source: 'local', marme1adker: true },
    { title: 'BONELAB', short: 'BONELAB', group: 'Инди • Разное', img: steamImg(1592190), tags: ['VR', 'Экшн', 'Физика'], opts: [], source: 'local', marme1adker: true },
    { title: 'Bongo Cat', short: 'Bongo Cat', group: 'Инди • Разное', img: steamImg(1172380), tags: ['Казуальное', 'Для всех'], opts: [], source: 'local', marme1adker: true },
    { title: 'Brawlhalla', short: 'Brawlhalla', group: 'Инди • Разное', img: steamImg(291550), tags: ['Файтинг', 'Мультиплеер', 'Кооп'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'BREACH', short: 'BREACH', group: 'Инди • Разное', img: steamImg(1296530), tags: ['Шутер', 'Тактика', 'Мультиплеер'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Bro Falls: Ultimate Showdown', short: 'Bro Falls: Ultimate ', group: 'Инди • Разное', img: steamImg(1457960), tags: ['Аркада', 'Мультиплеер', 'Кооп'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Brotato', short: 'Brotato', group: 'Инди • Разное', img: steamImg(1942280), tags: ['Roguelike', 'Экшн', 'Хардкор'], opts: [], source: 'local', marme1adker: true },
    { title: 'BROTHER!!! - Hardcore Platformer', short: 'BROTHER!!! - Hardcor', group: 'Инди • Разное', img: steamImg(1437670), tags: ['Платформер', 'Хардкор', 'Инди'], opts: [], source: 'local', marme1adker: true },
    { title: 'Bulb Boy', short: 'Bulb Boy', group: 'Инди • Разное', img: steamImg(390060), tags: ['Хоррор', 'Головоломка', 'Атмосфера'], opts: [], source: 'local', marme1adker: true },
    { title: 'Capcom Arcade Stadium', short: 'Capcom Arcade Stadiu', group: 'Инди • Разное', img: steamImg(1515950), tags: ['Аркада', 'Классика', 'Ретро'], opts: ['dlc'], source: 'local', marme1adker: true },
    ...
    { title: 'Counter-Strike', short: 'Counter-Strike', group: 'Valve', img: steamImg(10), tags: ['Шутер', 'Мультиплеер', 'Классика'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Counter-Strike 2', short: 'Counter-Strike 2', group: 'Valve', img: steamImg(730), tags: ['Шутер', 'Мультиплеер'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Counter-Strike: Condition Zero', short: 'Counter-Strike: Cond', group: 'Valve', img: steamImg(80), tags: ['Шутер', 'Мультиплеер', 'Классика'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Counter-Strike: Condition Zero Deleted Scenes', short: 'Counter-Strike: Cond', group: 'Valve', img: steamImg(80), tags: ['Шутер', 'Классика'], opts: [], source: 'local', marme1adker: true },
    { title: 'Counter-Strike: Source', short: 'Counter-Strike: Sour', group: 'Valve', img: steamImg(240), tags: ['Шутер', 'Мультиплеер', 'Классика'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Crosshair V2', short: 'Crosshair V2', group: 'Инди • Разное', img: steamImg(1070910), tags: ['Утилита'], opts: [], source: 'local', marme1adker: true },
    { title: 'CRYPTARK', short: 'CRYPTARK', group: 'Инди • Разное', img: steamImg(344740), tags: ['Roguelike', 'Шутер', 'Кооп'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Cursedland', short: 'Cursedland', group: 'Инди • Разное', img: steamImg(2205430), tags: ['Выживание', 'Стратегия'], opts: [], source: 'local', marme1adker: true },
    { title: 'DARK SOULS™ II', short: 'DARK SOULS™ II', group: 'FromSoftware', img: steamImg(236430), tags: ['Souls-like', 'Хардкор', 'Экшн'], opts: ['dlc'], source: 'local', marme1adker: true },
    { title: 'DARK SOULS™ II: Scholar of the First Sin', short: 'DARK SOULS™ II: Scho', group: 'FromSoftware', img: steamImg(335300), tags: ['Souls-like', 'Хардкор', 'Экшн'], opts: ['dlc'], source: 'local', marme1adker: true },
    { title: 'DARK SOULS™ III', short: 'DARK SOULS™ III', group: 'FromSoftware', img: steamImg(374320), tags: ['Souls-like', 'Хардкор', 'Экшн'], opts: ['dlc'], source: 'local', marme1adker: true },
    { title: 'DARK SOULS™: REMASTERED', short: 'DARK SOULS™: REMASTE', group: 'FromSoftware', img: steamImg(570940), tags: ['Souls-like', 'Хардкор', 'Экшн'], opts: [], source: 'local', marme1adker: true },
    { title: 'Day of Defeat', short: 'Day of Defeat', group: 'Valve', img: steamImg(30), tags: ['Инди'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Day of Defeat: Source', short: 'Day of Defeat: Sourc', group: 'Valve', img: steamImg(300), tags: ['Инди'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'DDNet', short: 'DDNet', group: 'Инди • Разное', img: steamImg(412890), tags: ['Платформер', 'Кооп', 'Хардкор'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Dead Island Riptide Definitive Edition', short: 'Dead Island Riptide ', group: 'Инди • Разное', img: steamImg(250700), tags: ['Зомби', 'Кооп', 'Открытый мир'], opts: [], source: 'local', marme1adker: true },
    { title: 'Deadlock', short: 'Deadlock', group: 'Инди • Разное', img: steamImg(1422450), tags: ['Шутер', 'MOBA', 'Мультиплеер'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Deathmatch Classic', short: 'Deathmatch Classic', group: 'Valve', img: steamImg(40), tags: ['Шутер', 'Мультиплеер', 'Классика'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Deceit', short: 'Deceit', group: 'Инди • Разное', img: steamImg(466240), tags: ['Хоррор', 'Мультиплеер', 'Асимметричный'], opts: [], source: 'local', marme1adker: true },
    { title: 'Desktop Mate', short: 'Desktop Mate', group: 'Инди • Разное', img: steamImg(1684590), tags: ['Утилита', 'Кастомизация'], opts: [], source: 'local', marme1adker: true },
    { title: 'Desktop Survivors 98', short: 'Desktop Survivors 98', group: 'Инди • Разное', img: steamImg(2240230), tags: ['Выживание', 'Необычное', 'Инди'], opts: [], source: 'local', marme1adker: true },
    { title: 'Devil May Cry 4 Special Edition', short: 'Devil May Cry 4 Spec', group: 'Инди • Разное', img: steamImg(329050), tags: ['Экшн', 'Слэшер', 'Хардкор'], opts: [], source: 'local', marme1adker: true },
    { title: 'Devil May Cry HD Collection', short: 'Devil May Cry HD Col', group: 'Инди • Разное', img: steamImg(631510), tags: ['Экшн', 'Слэшер', 'Классика'], opts: [], source: 'local', marme1adker: true },
    { title: 'Discord Bot Builder', short: 'Discord Bot Builder', group: 'Инди • Разное', img: steamImg(1018020), tags: ['Утилита'], opts: [], source: 'local', marme1adker: true },
    { title: 'Discord Bot Maker', short: 'Discord Bot Maker', group: 'Инди • Разное', img: steamImg(682130), tags: ['Утилита'], opts: [], source: 'local', marme1adker: true },
    { title: 'DISSIDIA FINAL FANTASY NT Free Edition', short: 'DISSIDIA FINAL FANTA', group: 'Инди • Разное', img: steamImg(765710), tags: ['Файтинг', 'Аниме', 'Мультиплеер'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Don\'t Starve Together', short: 'Don\'t Starve Togeth', group: 'Инди • Разное', img: steamImg(0), tags: ['Инди'], opts: [], source: 'local', marme1adker: true },
    { title: 'Dragonheir: Silent Gods', short: 'Dragonheir: Silent G', group: 'Инди • Разное', img: steamImg(2169640), tags: ['RPG', 'Стратегия', 'Фэнтези'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Dreams of Aether', short: 'Dreams of Aether', group: 'Инди • Разное', img: steamImg(3463050), tags: ['Приключение', 'Атмосфера'], opts: [], source: 'local', marme1adker: true },
    { title: 'Drunken Wrestlers 2', short: 'Drunken Wrestlers 2', group: 'Инди • Разное', img: steamImg(1408140), tags: ['Файтинг', 'Физика', 'Юмор'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Dungeonborne', short: 'Dungeonborne', group: 'Инди • Разное', img: steamImg(2075840), tags: ['RPG', 'Мультиплеер', 'Экшн'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'DYNASTY WARRIORS 9', short: 'DYNASTY WARRIORS 9', group: 'Инди • Разное', img: steamImg(485510), tags: ['Экшн', 'Открытый мир', 'История'], opts: [], source: 'local', marme1adker: true },
    { title: 'ELDEN RING NIGHTREIGN', short: 'ELDEN RING NIGHTREIG', group: 'FromSoftware', img: steamImg(2622380), tags: ['Souls-like', 'Кооп', 'Хардкор'], opts: ['dlc', 'online'], source: 'local', marme1adker: true },
    { title: 'ENDLESS™ Legend', short: 'ENDLESS™ Legend', group: 'Инди • Разное', img: steamImg(289130), tags: ['Стратегия', 'Пошаговая', 'Фэнтези'], opts: ['dlc'], source: 'local', marme1adker: true },
    { title: 'Figment', short: 'Figment', group: 'Инди • Разное', img: steamImg(493540), tags: ['Приключение', 'Головоломка', 'Атмосфера'], opts: [], source: 'local', marme1adker: true },
    { title: 'Fishing Planet', short: 'Fishing Planet', group: 'Инди • Разное', img: steamImg(380600), tags: ['Симулятор', 'Рыбалка', 'Кооп'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Friday the 13th: Killer Puzzle', short: 'Friday the 13th: Kil', group: 'Инди • Разное', img: steamImg(760150), tags: ['Головоломка', 'Хоррор', 'Казуальное'], opts: [], source: 'local', marme1adker: true },
    { title: 'Garry\'s Mod', short: 'Garry\'s Mod', group: 'Valve', img: steamImg(4000), tags: ['Инди'], opts: [], source: 'local', marme1adker: true },
    { title: 'Ghostrunner Demo', short: 'Ghostrunner Demo', group: 'Инди • Разное', img: steamImg(1348500), tags: ['Шутер', 'Паркур', 'Хардкор'], opts: [], source: 'local', marme1adker: true },
    { title: 'Google Earth VR', short: 'Google Earth VR', group: 'Инди • Разное', img: steamImg(348250), tags: ['VR', 'Исследование'], opts: [], source: 'local', marme1adker: true },
    { title: 'Half-Life 2: VR Mod', short: 'Half-Life 2: VR Mod', group: 'Valve', img: steamImg(658920), tags: ['Шутер', 'VR', 'Классика'], opts: [], source: 'local', marme1adker: true },
    { title: 'Half-Life: Blue Shift', short: 'Half-Life: Blue Shif', group: 'Valve', img: steamImg(130), tags: ['Инди'], opts: [], source: 'local', marme1adker: true },
    { title: 'Half-Life Deathmatch: Source', short: 'Half-Life Deathmatch', group: 'Valve', img: steamImg(360), tags: ['Шутер', 'Мультиплеер', 'Классика'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Half-Life: Source', short: 'Half-Life: Source', group: 'Valve', img: steamImg(280), tags: ['Шутер', 'Классика', 'Сюжет'], opts: [], source: 'local', marme1adker: true },
    ...
    { title: 'Hatred', short: 'Hatred', group: 'Инди • Разное', img: steamImg(341940), tags: ['Шутер', 'Необычное', 'Экшн'], opts: [], source: 'local', marme1adker: true },
    { title: 'House of Detention', short: 'House of Detention', group: 'Инди • Разное', img: steamImg(2251060), tags: ['Хоррор', 'Атмосфера'], opts: [], source: 'local', marme1adker: true },
    { title: 'Hue', short: 'Hue', group: 'Инди • Разное', img: steamImg(383270), tags: ['Платформер', 'Головоломка', 'Атмосфера'], opts: [], source: 'local', marme1adker: true },
    { title: 'Idol Showdown', short: 'Idol Showdown', group: 'Инди • Разное', img: steamImg(1740280), tags: ['Файтинг', 'Аниме', 'Мультиплеер'], opts: [], source: 'local', marme1adker: true },
    { title: 'Infinite Widgets', short: 'Infinite Widgets', group: 'Инди • Разное', img: steamImg(1902540), tags: ['Утилита', 'Кастомизация'], opts: [], source: 'local', marme1adker: true },
    { title: 'INITIAL D Playtest', short: 'INITIAL D Playtest', group: 'Инди • Разное', img: steamImg(2305980), tags: ['Гонки', 'Дрифт'], opts: [], source: 'local', marme1adker: true },
    { title: 'Initial Drift Online', short: 'Initial Drift Online', group: 'Инди • Разное', img: steamImg(1049600), tags: ['Гонки', 'Дрифт', 'Мультиплеер'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'iTop Easy Desktop for Steam', short: 'iTop Easy Desktop fo', group: 'Инди • Разное', img: steamImg(1537390), tags: ['Утилита'], opts: [], source: 'local', marme1adker: true },
    { title: 'Kiki', short: 'Kiki', group: 'Инди • Разное', img: steamImg(2142680), tags: ['Инди', 'Необычное'], opts: [], source: 'local', marme1adker: true },
    { title: 'LASERS', short: 'LASERS', group: 'Инди • Разное', img: steamImg(1120760), tags: ['Головоломка', 'Физика', 'Инди'], opts: [], source: 'local', marme1adker: true },
    { title: 'LEGO® 2K Drive', short: 'LEGO® 2K Drive', group: 'Инди • Симулятор', img: steamImg(1802190), tags: ['Гонки', 'Для всех', 'LEGO'], opts: ['dlc', 'online'], source: 'local', marme1adker: true },
    ...
    { title: 'Lightmatter', short: 'Lightmatter', group: 'Инди • Разное', img: steamImg(1050020), tags: ['Головоломка', 'Атмосфера', 'Инди'], opts: [], source: 'local', marme1adker: true },
    { title: 'Lost in Anomaly', short: 'Lost in Anomaly', group: 'Инди • Разное', img: steamImg(3312020), tags: ['Инди', 'Необычное'], opts: [], source: 'local', marme1adker: true },
    { title: 'Magellania', short: 'Magellania', group: 'Инди • Разное', img: steamImg(1740220), tags: ['Приключение', 'Атмосфера'], opts: [], source: 'local', marme1adker: true },
    { title: 'Magic: The Gathering Arena', short: 'Magic: The Gathering', group: 'Инди • Разное', img: steamImg(2141910), tags: ['Карточная', 'Стратегия', 'Мультиплеер'], opts: ['online'], source: 'local', marme1adker: true },
    ...
    { title: 'Marvel\'s Spider-Man: Miles Morales', short: 'Marvel\'s Spider-Man', group: 'PlayStation', img: steamImg(1817190), tags: ['Открытый мир', 'Экшн', 'Супергерой'], opts: [], source: 'local', marme1adker: true },
    { title: 'Marvel\'s Spider-Man Remastered', short: 'Marvel\'s Spider-Man', group: 'PlayStation', img: steamImg(1817070), tags: ['Открытый мир', 'Экшн', 'Супергерой'], opts: [], source: 'local', marme1adker: true },
    { title: 'Megabonk', short: 'Megabonk', group: 'Инди • Разное', img: steamImg(3405340), tags: ['Инди', 'Необычное'], opts: [], source: 'local', marme1adker: true },
    { title: 'Metro: Last Light Complete Edition', short: 'Metro: Last Light Co', group: 'Инди • Разное', img: steamImg(43110), tags: ['Шутер', 'Постапокалипсис', 'Атмосфера'], opts: [], source: 'local', marme1adker: true },
    { title: 'Mini Thief', short: 'Mini Thief', group: 'Инди • Разное', img: steamImg(481870), tags: ['Казуальное', 'Инди'], opts: [], source: 'local', marme1adker: true },
    { title: 'MISERY', short: 'MISERY', group: 'Инди • Разное', img: steamImg(2119830), tags: ['Инди', 'Необычное'], opts: [], source: 'local', marme1adker: true },
    { title: 'MyDockFinder', short: 'MyDockFinder', group: 'Инди • Разное', img: steamImg(1231750), tags: ['Утилита', 'Кастомизация'], opts: [], source: 'local', marme1adker: true },
    { title: 'NARAKA: BLADEPOINT', short: 'NARAKA: BLADEPOINT', group: 'Инди • Разное', img: steamImg(1172380), tags: ['Экшн', 'Мультиплеер', 'Боевые искусства'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Neverwinter', short: 'Neverwinter', group: 'Инди • Разное', img: steamImg(109600), tags: ['MMORPG', 'RPG', 'Фэнтези'], opts: ['online'], source: 'local', marme1adker: true },
    ...
    { title: 'One Gun Guy', short: 'One Gun Guy', group: 'Инди • Разное', img: steamImg(1200580), tags: ['Экшн', 'Инди'], opts: [], source: 'local', marme1adker: true },
    { title: 'OneShift', short: 'OneShift', group: 'Инди • Разное', img: steamImg(862740), tags: ['Инди', 'Необычное'], opts: [], source: 'local', marme1adker: true },
    { title: 'Paint Chips', short: 'Paint Chips', group: 'Инди • Разное', img: steamImg(1588920), tags: ['Казуальное', 'Инди'], opts: [], source: 'local', marme1adker: true },
    ...
    { title: 'Paragnosia', short: 'Paragnosia', group: 'Инди • Разное', img: steamImg(1769310), tags: ['RPG', 'Инди'], opts: [], source: 'local', marme1adker: true },
    { title: 'Party Quiz', short: 'Party Quiz', group: 'Инди • Разное', img: steamImg(1525060), tags: ['Казуальное', 'Для всех', 'Кооп'], opts: [], source: 'local', marme1adker: true },
    ...
    { title: 'Pool Nation FX', short: 'Pool Nation FX', group: 'Инди • Разное', img: steamImg(319800), tags: ['Спорт', 'Казуальное'], opts: [], source: 'local', marme1adker: true },
    { title: 'Poppy Playtime', short: 'Poppy Playtime', group: 'Инди • Разное', img: steamImg(1637320), tags: ['Хоррор', 'Головоломка', 'Сюжет'], opts: [], source: 'local', marme1adker: true },
    { title: 'POSTAL', short: 'POSTAL', group: 'Инди • Разное', img: steamImg(232770), tags: ['Шутер', 'Открытый мир', 'Юмор', 'Классика'], opts: [], source: 'local', marme1adker: true },
    { title: 'POSTAL: Brain Damaged', short: 'POSTAL: Brain Damage', group: 'Инди • Разное', img: steamImg(1359980), tags: ['Шутер', 'Юмор', 'Экшн'], opts: [], source: 'local', marme1adker: true },
    { title: 'PUBG: BATTLEGROUNDS', short: 'PUBG: BATTLEGROUNDS', group: 'Инди • Разное', img: steamImg(578080), tags: ['Шутер', 'Батл Рояль', 'Мультиплеер'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'PUBG: Experimental Server', short: 'PUBG: Experimental S', group: 'Инди • Разное', img: steamImg(900990), tags: ['Шутер', 'Батл Рояль'], opts: [], source: 'local', marme1adker: true },
    { title: 'PUBG: Test Server', short: 'PUBG: Test Server', group: 'Инди • Разное', img: steamImg(503250), tags: ['Шутер', 'Батл Рояль'], opts: [], source: 'local', marme1adker: true },
    { title: 'Rat Quest', short: 'Rat Quest', group: 'Инди • Разное', img: steamImg(2277390), tags: ['RPG', 'Инди', 'Необычное'], opts: [], source: 'local', marme1adker: true },
    { title: 'Ricochet', short: 'Ricochet', group: 'Valve', img: steamImg(60), tags: ['Классика', 'Мультиплеер'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'RPG Maker VX Ace', short: 'RPG Maker VX Ace', group: 'Инди • Разное', img: steamImg(220700), tags: ['Утилита', 'Разработка'], opts: [], source: 'local', marme1adker: true },
    { title: 'RPG Maker XP', short: 'RPG Maker XP', group: 'Инди • Разное', img: steamImg(235900), tags: ['Утилита', 'Разработка'], opts: [], source: 'local', marme1adker: true },
    { title: 'RPG Paper Maker', short: 'RPG Paper Maker', group: 'Инди • Разное', img: steamImg(1183060), tags: ['Утилита', 'Разработка'], opts: [], source: 'local', marme1adker: true },
    { title: 'RUMBLE', short: 'RUMBLE', group: 'Инди • Разное', img: steamImg(890550), tags: ['VR', 'Файтинг', 'Мультиплеер'], opts: ['online'], source: 'local', marme1adker: true },
    ...
    { title: 'Rust - Staging Branch', short: 'Rust - Staging Branc', group: 'Инди • Разное', img: steamImg(252490), tags: ['Выживание', 'Крафт'], opts: [], source: 'local', marme1adker: true },
    { title: 'SAO Utils 2: Progressive', short: 'SAO Utils 2: Progres', group: 'Инди • Разное', img: steamImg(1664260), tags: ['Утилита', 'Аниме'], opts: [], source: 'local', marme1adker: true },
    { title: 'SCP: Containment Breach Multiplayer', short: 'SCP: Containment Bre', group: 'Инди • Разное', img: steamImg(1878980), tags: ['Хоррор', 'Мультиплеер', 'Выживание'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'SCP: Secret Laboratory', short: 'SCP: Secret Laborato', group: 'Инди • Разное', img: steamImg(700330), tags: ['Хоррор', 'Мультиплеер'], opts: [], source: 'local', marme1adker: true },
    ...
    { title: 'Sekiro™: Shadows Die Twice', short: 'Sekiro™: Shadows Die', group: 'FromSoftware', img: steamImg(814380), tags: ['Souls-like', 'Хардкор', 'Стелс'], opts: [], source: 'local', marme1adker: true },
    { title: 'Sex and the Furry Titty 3: Come Inside, Sweet...', short: 'Sex and the Furry Ti', group: 'Инди • Разное', img: steamImg(2900380), tags: ['Инди', 'Необычное'], opts: [], source: 'local', marme1adker: true },
    { title: 'ShareX', short: 'ShareX', group: 'Инди • Разное', img: steamImg(400040), tags: ['Утилита'], opts: [], source: 'local', marme1adker: true },
    { title: 'skate.', short: 'skate.', group: 'Инди • Разное', img: steamImg(1245620), tags: ['Спорт', 'Аркада'], opts: [], source: 'local', marme1adker: true },
    { title: 'SLUDGE LIFE', short: 'SLUDGE LIFE', group: 'Инди • Разное', img: steamImg(1114140), tags: ['Приключение', 'Необычное', 'Атмосфера'], opts: [], source: 'local', marme1adker: true },
    { title: 'Smart Factory Tycoon', short: 'Smart Factory Tycoon', group: 'Инди • Разное', img: steamImg(2052940), tags: ['Симулятор', 'Строительство', 'Стратегия'], opts: [], source: 'local', marme1adker: true },
    { title: 'SMITE', short: 'SMITE', group: 'Инди • Разное', img: steamImg(386360), tags: ['MOBA', 'Мифология', 'Мультиплеер'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'SMITE - Public Test', short: 'SMITE - Public Test', group: 'Инди • Разное', img: steamImg(443720), tags: ['MOBA', 'Мифология'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'SMITE 2', short: 'SMITE 2', group: 'Инди • Разное', img: steamImg(2437490), tags: ['MOBA', 'Мифология', 'Мультиплеер'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Snake Eyes Dungeon', short: 'Snake Eyes Dungeon', group: 'Инди • Разное', img: steamImg(2038500), tags: ['Roguelike', 'Карточная', 'Инди'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Soundpad', short: 'Soundpad', group: 'Инди • Разное', img: steamImg(629520), tags: ['Утилита'], opts: [], source: 'local', marme1adker: true },
    { title: 'Space Crew: Legendary Edition', short: 'Space Crew: Legendar', group: 'Инди • Разное', img: steamImg(1176710), tags: ['Стратегия', 'Космос', 'Кооп'], opts: ['dlc', 'online'], source: 'local', marme1adker: true },
    { title: 'Splitgate', short: 'Splitgate', group: 'Инди • Разное', img: steamImg(677620), tags: ['Шутер', 'Порталы', 'Мультиплеер'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Stellar Mess: The Princess Conundrum (Chapter...)', short: 'Stellar Mess: The Pr', group: 'Инди • Разное', img: steamImg(1507530), tags: ['Приключение', 'Инди'], opts: [], source: 'local', marme1adker: true },
    { title: 'Strinova', short: 'Strinova', group: 'Инди • Разное', img: steamImg(2585940), tags: ['Шутер', 'Аниме', 'Мультиплеер'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Stumble Guys', short: 'Stumble Guys', group: 'Инди • Разное', img: steamImg(1677740), tags: ['Аркада', 'Мультиплеер', 'Для всех'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Tachyonest', short: 'Tachyonest', group: 'Инди • Разное', img: steamImg(1505790), tags: ['Инди', 'Необычное'], opts: [], source: 'local', marme1adker: true },
    { title: 'Team Fortress Classic', short: 'Team Fortress Classi', group: 'Valve', img: steamImg(20), tags: ['Инди'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Tell Me Why', short: 'Tell Me Why', group: 'Инди • Разное', img: steamImg(1180660), tags: ['Сюжет', 'Приключение', 'Инди'], opts: [], source: 'local', marme1adker: true },
    { title: 'TGV Voyages Train Simulator', short: 'TGV Voyages Train Si', group: 'Инди • Разное', img: steamImg(1641590), tags: ['Инди'], opts: [], source: 'local', marme1adker: true },
    { title: 'The Council', short: 'The Council', group: 'Инди • Разное', img: steamImg(718650), tags: ['Сюжет', 'RPG', 'Приключение'], opts: [], source: 'local', marme1adker: true },
    { title: 'The Elder Scrolls Online', short: 'The Elder Scrolls On', group: 'Bethesda', img: steamImg(306130), tags: ['MMORPG', 'Открытый мир', 'Фэнтези'], opts: ['dlc', 'online'], source: 'local', marme1adker: true },
    { title: 'The Elder Scrolls V: Skyrim VR', short: 'The Elder Scrolls V:', group: 'Bethesda', img: steamImg(611670), tags: ['Открытый мир', 'RPG', 'VR'], opts: [], source: 'local', marme1adker: true },
    { title: 'The Jackbox Megapicker', short: 'The Jackbox Megapick', group: 'Инди • Разное', img: steamImg(2867660), tags: ['Казуальное', 'Для всех', 'Кооп'], opts: [], source: 'local', marme1adker: true },
    { title: 'The Lab', short: 'The Lab', group: 'Инди • Разное', img: steamImg(450390), tags: ['VR', 'Казуальное'], opts: [], source: 'local', marme1adker: true },
    { title: 'The Lion\'s Song', short: 'The Lion\'s Song', group: 'Инди • Разное', img: steamImg(512740), tags: ['Визуальная новелла', 'Атмосфера', 'Инди'], opts: [], source: 'local', marme1adker: true },
    { title: 'The Witcher 2: Assassins of Kings Enhanced Edition', short: 'The Witcher 2: Assas', group: 'CD Projekt Red', img: steamImg(20920), tags: ['RPG', 'Сюжет', 'Фэнтези'], opts: [], source: 'local', marme1adker: true },
    { title: 'Three Sisters', short: 'Three Sisters', group: 'Инди • Разное', img: steamImg(3584190), tags: ['Визуальная новелла', 'Инди'], opts: [], source: 'local', marme1adker: true },
    { title: 'tide—1927—', short: 'tide—1927—', group: 'Инди • Разное', img: steamImg(1696790), tags: ['Инди', 'Необычное'], opts: [], source: 'local', marme1adker: true },
    { title: 'tModLoader - Обновление в очереди', short: 'tModLoader - Обновле', group: 'Инди • Разное', img: steamImg(1281930), tags: ['Моддинг', 'Для всех'], opts: [], source: 'local', marme1adker: true },
    { title: 'Tom Clancy\'s Rainbow Six Siege - Test Server', short: 'Tom Clancy\'s Rainbo', group: 'Инди • Разное', img: steamImg(359550), tags: ['Шутер', 'Тактика', 'Мультиплеер'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Tom Clancy\'s Rainbow Six® Siege X', short: 'Tom Clancy\'s Rainbo', group: 'Инди • Разное', img: steamImg(359550), tags: ['Шутер', 'Тактика', 'Мультиплеер'], opts: ['dlc', 'online'], source: 'local', marme1adker: true },
    { title: 'Toy Tinker Simulator', short: 'Toy Tinker Simulator', group: 'Инди • Разное', img: steamImg(1149690), tags: ['Симулятор', 'Расслабляющее'], opts: [], source: 'local', marme1adker: true },
    { title: 'Train Simulator Classic', short: 'Train Simulator Clas', group: 'Инди • Разное', img: steamImg(24010), tags: ['Симулятор', 'Поезд'], opts: ['dlc'], source: 'local', marme1adker: true },
    { title: 'Truck World: Driving School', short: 'Truck World: Driving', group: 'Инди • Разное', img: steamImg(1456860), tags: ['Симулятор', 'Грузовики'], opts: [], source: 'local', marme1adker: true },
    { title: 'Ultimate Zombie Defense', short: 'Ultimate Zombie Defe', group: 'Инди • Разное', img: steamImg(1120420), tags: ['Выживание', 'Зомби', 'Кооп'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'ULTRAKILL', short: 'ULTRAKILL', group: 'Инди • Разное', img: steamImg(1229490), tags: ['Инди'], opts: [], source: 'local', marme1adker: true },
    { title: 'Unplagued', short: 'Unplagued', group: 'Инди • Разное', img: steamImg(1623480), tags: ['Стратегия', 'Выживание'], opts: [], source: 'local', marme1adker: true },
    { title: 'Untrusted', short: 'Untrusted', group: 'Инди • Разное', img: steamImg(1708530), tags: ['Инди', 'Необычное'], opts: [], source: 'local', marme1adker: true },
    { title: 'Upload Labs', short: 'Upload Labs', group: 'Инди • Разное', img: steamImg(1638490), tags: ['Инди', 'Необычное'], opts: [], source: 'local', marme1adker: true },
    { title: 'Verho - Curse of Faces', short: 'Verho - Curse of Fac', group: 'Инди • Разное', img: steamImg(2116540), tags: ['Хоррор', 'Атмосфера'], opts: [], source: 'local', marme1adker: true },
    { title: 'VRChat', short: 'VRChat', group: 'Инди • Разное', img: steamImg(438100), tags: ['VR', 'Социальное', 'Для всех'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'WarBots', short: 'WarBots', group: 'Инди • Разное', img: steamImg(1220420), tags: ['Экшн', 'Роботы', 'Мультиплеер'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Warframe', short: 'Warframe', group: 'Инди • Разное', img: steamImg(230410), tags: ['Шутер', 'RPG', 'Мультиплеер'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Warhammer 40,000: Gladius - Relics of War', short: 'Warhammer 40,000: Gl', group: 'Инди • Разное', img: steamImg(489630), tags: ['Стратегия', 'Пошаговая', '40K'], opts: ['dlc'], source: 'local', marme1adker: true },
    { title: 'Wednesdays', short: 'Wednesdays', group: 'Инди • Разное', img: steamImg(2747770), tags: ['Инди', 'Необычное'], opts: [], source: 'local', marme1adker: true },
    { title: 'Where Winds Meet', short: 'Where Winds Meet', group: 'Инди • Разное', img: steamImg(2159850), tags: ['MMORPG', 'Открытый мир'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Wild Terra 2: New Lands', short: 'Wild Terra 2: New La', group: 'Инди • Разное', img: steamImg(1065820), tags: ['MMORPG', 'Выживание', 'Крафт'], opts: ['online'], source: 'local', marme1adker: true },
    { title: 'Will Glow the Wisp Demo', short: 'Will Glow the Wisp D', group: 'Инди • Разное', img: steamImg(2720720), tags: ['Инди', 'Платформер'], opts: [], source: 'local', marme1adker: true },
    { title: 'Wrap House Simulator: Prologue', short: 'Wrap House Simulator', group: 'Инди • Разное', img: steamImg(2695600), tags: ['Симулятор', 'Расслабляющее'], opts: [], source: 'local', marme1adker: true },
    { title: 'Wuthering Waves', short: 'Wuthering Waves', group: 'Инди • Разное', img: steamImg(2565880), tags: ['RPG', 'Открытый мир', 'Аниме'], opts: [], source: 'local', marme1adker: true },
    { title: 'Z.O.N.A: Origin', short: 'Z.O.N.A: Origin', group: 'Инди • Разное', img: steamImg(1045500), tags: ['Шутер', 'Атмосфера', 'Постапокалипсис'], opts: [], source: 'local', marme1adker: true },
    // ── Инди • Разное (новые) ─────────────────────────────────────
    { title: 'Little Nightmares Enhanced Edition',    short: 'LN Enhanced',        group: 'Инди • Разное',       img: steamImg(860510),   hasDlc: true,  tags: ['Хоррор', 'Платформер', 'Атмосфера'],            opts: ['dlc'],            source: 'local' ,  marme1adker: true },
